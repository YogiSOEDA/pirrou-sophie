...
window.onload = function () {
  ...
  function init() {
    ...
    // book.setAttribute("hidden", "hidden");
    // prev_btn.setAttribute("hidden", "hidden");
    // next_btn.setAttribute("hidden", "hidden");
  }
...
function reveal() {
  ...
  var prev_btn = document.getElementById("prev-btn");
  var next_btn = document.getElementById("next-btn");
  var audio_btn = document.getElementById("btn-audio");
  ...
  audio_btn.removeAttribute("hidden");
